...
_G.packer_plugins = {
  ...
  ["galaxyline.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/davidrosenberg/.local/share/lunarvim/site/pack/packer/opt/galaxyline.nvim"
  },
  ["gitsigns.nvim"] = {
  ...
  ["vim-rooter"] = {
    ...
    loaded = true,
    path = "/Users/davidrosenberg/.local/share/lunarvim/site/pack/packer/start/vim-rooter"
  },
  ["vim-vsnip"] = {
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'barbar.nvim', 'which-key.nvim', 'dashboard-nvim', 'nvim-toggleterm.lua', 'galaxyline.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
