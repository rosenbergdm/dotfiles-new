...
class ConfigurationFeature {
    ...
    onDidChangeConfiguration(configurationSection, event) {
        ...
        let didChangeConfiguration = (sections) => {
            ...
            this._client.sendNotification(vscode_languageserver_protocol_1.DidChangeConfigurationNotification.type, { settings: this.extractSettingsInformation(sections) }).catch((error) => {
                this._client.error(`Sending notification ${vscode_languageserver_protocol_1.DidChangeConfigurationNotification.type.method} failed`, error);
            });
        };
